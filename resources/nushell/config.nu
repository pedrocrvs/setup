...
def "prune junk" []: nothing -> nothing {
...
# Modules conditionally imported
const module_broot: string = "~/.config/broot/nushell_broot.nu"

use (if $nu.is-interactive and ($module_broot | path exists) { $module_broot } ) *
